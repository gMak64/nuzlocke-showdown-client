...
lifedew:{
anim:function(scene,_ref25){var attacker=_ref25[0],defenders=_ref25.slice(1);for(var _i2=0;_i2<
...
junglehealing:{
anim:function(scene,_ref26){var attacker=_ref26[0],defenders=_ref26.slice(1);
...
prepareAnim:function(scene,_ref92){var attacker=_ref92[0],defender=_ref92[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300
...
shelltrap:{
anim:function(scene,_ref182){var attacker=_ref182[0],defenders=_ref182.slice(1);for(var _i6=0;_i6<
...
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i14=0;_i14<

defenders.length;_i14++){var defender=defenders[_i14];for(var _i16=0,_ref214=
['mistball','heart'];_i16<_ref214.length;_i16++){var effect=_ref214[_i16];
for(var i=0;i<4;i++){
...
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i18=0;_i18<

defenders.length;_i18++){var defender=defenders[_i18];for(var _i20=0,_ref217=
['blackwisp','lightning'];_i20<_ref217.length;_i20++){var effect=_ref217[_i20];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
scene.backgroundEffect('#B47F1F',1000,0.3);for(var _i22=0;_i22<
...
boomburst:{
anim:function(scene,_ref227){var attacker=_ref227[0],defenders=_ref227.slice(1);for(var _i24=0;_i24<
...
heatwave:{
anim:function(scene,_ref228){var attacker=_ref228[0],defenders=_ref228.slice(1);for(var _i26=0;_i26<
defenders.length;_i26++){var _defender2=defenders[_i26];
...
icywind:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_ref255.slice(1);for(var _i28=0;_i28<
...
sludgewave:{
anim:function(scene,_ref265){var attacker=_ref265[0],defenders=_ref265.slice(1);for(var _i30=0;_i30<
defenders.length;_i30++){var _defender3=defenders[_i30];
...
rockslide:{
anim:function(scene,_ref277){var attacker=_ref277[0],defenders=_ref277.slice(1);for(var _i32=0;_i32<
...
thousandarrows:{
anim:function(scene,_ref280){var attacker=_ref280[0],defenders=_ref280.slice(1);for(var _i34=0;_i34<
defenders.length;_i34++){var _defender4=defenders[_i34];
...
thousandwaves:{
anim:function(scene,_ref281){var attacker=_ref281[0],defenders=_ref281.slice(1);for(var _i36=0;_i36<
defenders.length;_i36++){var _defender5=defenders[_i36];
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i38=0,_ref291=

['x','y',''];_i38<_ref291.length;_i38++){var axis=_ref291[_i38];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref293){var attacker=_ref293[0],defenders=_ref293.slice(1);for(var _i40=0;_i40<
...
makeitrain:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_ref331.slice(1);for(var _i42=0;_i42<
...
surf:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i44=0;_i44<
...
muddywater:{
anim:function(scene,_ref340){var attacker=_ref340[0],defenders=_ref340.slice(1);for(var _i46=0;_i46<
...
lavaplume:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i48=0;_i48<
...
dragonenergy:{
anim:function(scene,_ref343){var attacker=_ref343[0],defenders=_ref343.slice(1);for(var _i50=0;_i50<
...
eruption:{
anim:function(scene,_ref344){var attacker=_ref344[0],defenders=_ref344.slice(1);for(var _i52=0;_i52<
...
waterspout:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i54=0;_i54<
...
prepareAnim:function(scene,_ref348){var attacker=_ref348[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
scene.backgroundEffect("url('https://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i56=0;_i56<
...
darkvoid:{
anim:function(scene,_ref373){var attacker=_ref373[0],defenders=_ref373.slice(1);for(var _i58=0;_i58<
