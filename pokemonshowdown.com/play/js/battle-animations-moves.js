...
shelltrap:{
anim:function(scene,_ref181){var attacker=_ref181[0],defenders=_ref181.slice(1);for(var _i6=0;_i6<
...
defenders.length;_i14++){var defender=defenders[_i14];for(var _i16=0,_ref213=
['mistball','heart'];_i16<_ref213.length;_i16++){var effect=_ref213[_i16];
for(var i=0;i<4;i++){
...
defenders.length;_i18++){var defender=defenders[_i18];for(var _i20=0,_ref216=
['blackwisp','lightning'];_i20<_ref216.length;_i20++){var effect=_ref216[_i20];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
boomburst:{
anim:function(scene,_ref226){var attacker=_ref226[0],defenders=_ref226.slice(1);for(var _i24=0;_i24<
...
heatwave:{
anim:function(scene,_ref227){var attacker=_ref227[0],defenders=_ref227.slice(1);for(var _i26=0;_i26<
...
icywind:{
anim:function(scene,_ref254){var attacker=_ref254[0],defenders=_ref254.slice(1);for(var _i28=0;_i28<
...
sludgewave:{
anim:function(scene,_ref264){var attacker=_ref264[0],defenders=_ref264.slice(1);for(var _i30=0;_i30<
...
rockslide:{
anim:function(scene,_ref276){var attacker=_ref276[0],defenders=_ref276.slice(1);for(var _i32=0;_i32<
...
thousandwaves:{
anim:function(scene,_ref280){var attacker=_ref280[0],defenders=_ref280.slice(1);for(var _i36=0;_i36<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i38=0,_ref290=

['x','y',''];_i38<_ref290.length;_i38++){var axis=_ref290[_i38];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref292){var attacker=_ref292[0],defenders=_ref292.slice(1);for(var _i40=0;_i40<
...
makeitrain:{
anim:function(scene,_ref329){var attacker=_ref329[0],defenders=_ref329.slice(1);for(var _i42=0;_i42<
...
surf:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i44=0;_i44<
...
muddywater:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i46=0;_i46<
...
lavaplume:{
anim:function(scene,_ref340){var attacker=_ref340[0],defenders=_ref340.slice(1);for(var _i48=0;_i48<
...
dragonenergy:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i50=0;_i50<
...
eruption:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i52=0;_i52<
...
waterspout:{
anim:function(scene,_ref343){var attacker=_ref343[0],defenders=_ref343.slice(1);for(var _i54=0;_i54<
...
darkvoid:{
anim:function(scene,_ref369){var attacker=_ref369[0],defenders=_ref369.slice(1);for(var _i58=0;_i58<
...
mistyexplosion:{
anim:function(scene,_ref380){var attacker=_ref380[0];
scene.backgroundEffect('#FF99FF',700,0.5);
scene.showEffect('fireball',{
x:attacker.x+40,
y:attacker.y,
